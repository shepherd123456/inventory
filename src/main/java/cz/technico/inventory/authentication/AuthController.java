...
import cz.technico.inventory.authentication.email.EmailVerification;
import cz.technico.inventory.authentication.email.EmailVerificationService;
import cz.technico.inventory.authentication.email.SignUpEvent;
import cz.technico.inventory.authentication.jwt.JwtService;
import cz.technico.inventory.refreshtoken.RefreshToken;
import cz.technico.inventory.refreshtoken.RefreshTokenService;
import cz.technico.inventory.role.Role;
import cz.technico.inventory.role.RoleService;
import cz.technico.inventory.user.User;
import cz.technico.inventory.user.UserDtoin;
import cz.technico.inventory.user.UserService;
...
import static cz.technico.inventory.InventoryApplication.ACCESS_TOKEN_DURATION_SECONDS;
import static cz.technico.inventory.InventoryApplication.REFRESH_TOKEN_DURATION_SECONDS;
import static cz.technico.inventory.security.JwtCookie.createEmptyJwtCookie;
import static cz.technico.inventory.security.JwtCookie.createJwtCookie;
